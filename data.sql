...
INSERT INTO manufactureres (id, name, country_code, link, description, more_description) VALUES (1, 'Rhybox', 'FR', 'http://dummyimage.com/136x225.jpg/ff4444/ffffff', 'Poisoning by amphetamines, assault, sequela', 'Poisoning by amphetamines, assault, sequela');
INSERT INTO manufactureres (id, name, country_code, link, description, more_description) VALUES (2, 'Realbridge', 'FR', 'http://dummyimage.com/123x176.png/5fa2dd/ffffff', 'Juvenile osteochondrosis of radius and ulna', 'Juvenile osteochondrosis of radius an');
INSERT INTO manufactureres (id, name, country_code, link, description, more_description) VALUES (3, 'Blogtag', 'FR', 'http://dummyimage.com/201x115.bmp/5fa2dd/ffffff', 'Maternal care for chromosomal abnormality in fetus, fetus 5', 'Maternal care for (suspec');
INSERT INTO manufactureres (id, name, country_code, link, description, more_description) VALUES (4, 'Buzzshare', 'FR', 'http://dummyimage.com/196x228.bmp/5fa2dd/ffffff', 'Displ bicondylar fx unsp tibia, 7thM', 'Displaced bicondylar fracture of unspecified tibia');
INSERT INTO manufactureres (id, name, country_code, link, description, more_description) VALUES (5, 'Edgepulse', 'BR', 'http://dummyimage.com/119x201.jpg/dddddd/000000', 'Hypokalemia', 'Hypokalemia');
INSERT INTO manufactureres (id, name, country_code, link, description, more_description) VALUES (6, 'Mybuzz', 'BR', 'http://dummyimage.com/236x222.jpg/5fa2dd/ffffff', 'Other symptoms and signs involving appearance and behavior', 'Other symptoms and signs involving appear');
INSERT INTO manufactureres (id, name, country_code, link, description, more_description) VALUES (7, 'Flashspan', 'FR', 'http://dummyimage.com/110x167.bmp/cc0000/ffffff', 'Traum subrac hem w LOC >24 hr w/o ret consc w surv, init', 'Traumatic subarachnoid hemorrhage ');
INSERT INTO manufactureres (id, name, country_code, link, description, more_description) VALUES (8, 'Oozz', 'BE', 'http://dummyimage.com/240x227.jpg/dddddd/000000', 'Congenital absence of vagina', 'Congenital absence of vagina');
INSERT INTO manufactureres (id, name, country_code, link, description, more_description) VALUES (9, 'Bluezoom', 'BR', 'http://dummyimage.com/226x125.jpg/dddddd/000000', 'Nondisp commnt fx shaft of r tibia, 7thQ', 'Nondisplaced comminuted fracture of shaft of right tibia, ');
